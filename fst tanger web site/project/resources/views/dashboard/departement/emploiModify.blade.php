...
<body><div class="area">
    <div class="container">
        <form action="{{ route("Departement.Emploi.Show") }}" method="get">
        @csrf
        <div  class="select">
    ...
    <div class="table">
        <form action="{{ url("/dashboard/depEmploi/modify/".$selected->ID_loc) }}" method="post">
            @method('PUT')
            @csrf
    <table>
    ...
    <ul>
        ...
        <li class="has-subnav">
            <a href="{{route("Departement.Emploi.Show")}}" id="current">
