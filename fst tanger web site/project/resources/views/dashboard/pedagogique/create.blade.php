<html>
  ...
  <body><div class="area">
    <form  action="{{ route("Peda.Create.Modify") }}" method="post" class="form">
        @csrf
        ...
        <div class="input-box">
            ...
            <select name="role" id="" >
                <option value="0">Resonsable des services pedagogique</option>
                <option value="3" selected>Coordinateur</option>
    ...
    <nav class="main-menu">
        <ul>
            ...
            <li>
                <a href="{{route("Peda.Create")}}" id="current">
